...
public class ListarConsultaController implements Initializable{
	...
	@FXML private TableColumn<ConsultaVO, Calendar> data_consulta; // talez nao seja string
	@FXML private TableColumn<ConsultaVO, Calendar> hora_consulta;
	...
	public void listar(){
		...
		cpf.setCellValueFactory((TableColumn.CellDataFeatures<ConsultaVO, String> param) -> new SimpleStringProperty(param.getValue().getPaciente().getCpf()));
