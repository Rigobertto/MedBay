...
public class ListarPacienteController implements Initializable{
	...
	public void cadastrarConsulta(ActionEvent event) throws Exception{
		try {
			PacienteVO paciente = new PacienteVO();
			paciente = tabelaPaciente.getSelectionModel().getSelectedItem();
			CadastrarConsultaController.setPaciente(paciente);
	...
	public static void setLogin(int us) {
		login = us;
	}
}
